...
procedure TForm1.BitBtn1Click(Sender: TObject);
  ...
  //Riad.SetW();
    ...
    begin
      ...
      begin
        MessageDlg(Pchar(' выбрано значение w1!!!'),mtError,[mbOk],0);
      end
    else if w1=2 then
      begin
        MessageDlg(Pchar(' выбрано значение w2!!!'),mtError,[mbOk],0);
      end
     else if w1=3 then
      begin
        MessageDlg(Pchar(' выбрано значение w3!!!'),mtError,[mbOk],0);
